	...
	for !in.IsDelim('}') {
		...
		case "styles":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.Styles = append(out.Styles, v22)
					in.WantComma()
				}
				in.Delim(']')
			}
		case "categories":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.Categories = append(out.Categories, v23)
					in.WantComma()
				}
				in.Delim(']')
			}
		case "subcategories":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.Subcategories = append(out.Subcategories, v24)
					in.WantComma()
				}
				in.Delim(']')
			}
		case "seasons":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v25 Season
					v25 = Season(in.String())
					out.Seasons = append(out.Seasons, v25)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjson3e1fa5ecEncodeTryOnInternalPkgDomain16(out *jwriter.Writer, in ClothesClassificationRequest) {
	...
	if len(in.Subcategories) != 0 {
		...
		{
			out.RawByte('[')
			for v32, v33 := range in.Subcategories {
				if v32 > 0 {
					out.RawByte(',')
				}
	...
	for !in.IsDelim('}') {
		...
		case "seasons":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v37 Season
					v37 = Season(in.String())
					out.Seasons = append(out.Seasons, v37)
					in.WantComma()
				}
				in.Delim(']')
			}
