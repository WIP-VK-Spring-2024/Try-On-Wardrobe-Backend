	...
	for !in.IsDelim('}') {
		...
		case "clothes_ids":
			if in.IsNull() {
				...
				in.Delim('[')
				if out.ClothesIds == nil {
					if !in.IsDelim(']') {
						out.ClothesIds = make([]utils.UUID, 0, 4)
					} else {
						out.ClothesIds = []utils.UUID{}
					}
				} else {
					out.ClothesIds = (out.ClothesIds)[:0]
				}
				for !in.IsDelim(']') {
					var v18 utils.UUID
					if data := in.UnsafeBytes(); in.Ok() {
					...
					out.ClothesIds = append(out.ClothesIds, v18)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjson3e1fa5ecEncodeTryOnInternalPkgDomain18(out *jwriter.Writer, in Post) {
	...
	if len(in.ClothesIds) != 0 {
		const prefix string = ",\"clothes_ids\":"
		out.RawString(prefix)
		{
			out.RawByte('[')
			for v19, v20 := range in.ClothesIds {
				if v19 > 0 {
					out.RawByte(',')
				}
				out.RawText((v20).MarshalText())
			}
			out.RawByte(']')
		}
	}
	...
	for !in.IsDelim('}') {
		...
		case "outfits":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v21 OutfitGenOutfit
					(v21).UnmarshalEasyJSON(in)
					out.Outfits = append(out.Outfits, v21)
					in.WantComma()
				}
				in.Delim(']')
			}
		...
		case "purposes":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.Purposes = append(out.Purposes, v24)
					in.WantComma()
				}
				in.Delim(']')
			}
	...
	for !in.IsDelim('}') {
		...
		case "clothes":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v30 OutfitGenClothes
					(v30).UnmarshalEasyJSON(in)
					out.Clothes = append(out.Clothes, v30)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjson3e1fa5ecDecodeTryOnInternalPkgDomain26(in *jlexer.Lexer, out *GeoPosition) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson3e1fa5ecEncodeTryOnInternalPkgDomain26(out *jwriter.Writer, in GeoPosition) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Lat != 0 {
...
func easyjson3e1fa5ecDecodeTryOnInternalPkgDomain27(in *jlexer.Lexer, out *GenClothesInfo) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson3e1fa5ecEncodeTryOnInternalPkgDomain27(out *jwriter.Writer, in GenClothesInfo) {
	out.RawByte('{')
	first := true
	_ = first
	if (in.ClothesID).IsDefined() {
...
func easyjson3e1fa5ecDecodeTryOnInternalPkgDomain28(in *jlexer.Lexer, out *Credentials) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson3e1fa5ecEncodeTryOnInternalPkgDomain28(out *jwriter.Writer, in Credentials) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Name != "" {
...
func easyjson3e1fa5ecDecodeTryOnInternalPkgDomain29(in *jlexer.Lexer, out *CommentModel) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson3e1fa5ecEncodeTryOnInternalPkgDomain29(out *jwriter.Writer, in CommentModel) {
	out.RawByte('{')
	first := true
	_ = first
	if (in.UserID).IsDefined() {
...
func easyjson3e1fa5ecDecodeTryOnInternalPkgDomain30(in *jlexer.Lexer, out *Comment) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
		...
		case "replies":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.Replies = append(out.Replies, v39)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjson3e1fa5ecEncodeTryOnInternalPkgDomain30(out *jwriter.Writer, in Comment) {
	out.RawByte('{')
	first := true
	_ = first
	if in.UserName != "" {
...
func easyjson3e1fa5ecDecodeTryOnInternalPkgDomain31(in *jlexer.Lexer, out *ClothesProcessingResponse) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson3e1fa5ecEncodeTryOnInternalPkgDomain31(out *jwriter.Writer, in ClothesProcessingResponse) {
	out.RawByte('{')
	first := true
	_ = first
	if (in.UserID).IsDefined() {
...
func easyjson3e1fa5ecDecodeTryOnInternalPkgDomain32(in *jlexer.Lexer, out *ClothesProcessingRequest) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson3e1fa5ecEncodeTryOnInternalPkgDomain32(out *jwriter.Writer, in ClothesProcessingRequest) {
	out.RawByte('{')
	first := true
	_ = first
	if (in.UserID).IsDefined() {
...
func easyjson3e1fa5ecDecodeTryOnInternalPkgDomain33(in *jlexer.Lexer, out *ClothesProcessingModelResponse) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson3e1fa5ecEncodeTryOnInternalPkgDomain33(out *jwriter.Writer, in ClothesProcessingModelResponse) {
	out.RawByte('{')
	first := true
	_ = first
	if (in.UserID).IsDefined() {
...
func easyjson3e1fa5ecDecodeTryOnInternalPkgDomain34(in *jlexer.Lexer, out *ClothesClassificationResponse) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
	...
	for !in.IsDelim('}') {
		...
		case "seasons":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v42 Season
					v42 = Season(in.String())
					out.Seasons = append(out.Seasons, v42)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjson3e1fa5ecEncodeTryOnInternalPkgDomain34(out *jwriter.Writer, in ClothesClassificationResponse) {
	out.RawByte('{')
	first := true
	_ = first
...
func easyjson3e1fa5ecDecodeTryOnInternalPkgDomain35(in *jlexer.Lexer, out *ClothesClassificationRequest) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
		...
		case "styles":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.Styles = append(out.Styles, v49)
					in.WantComma()
				}
				in.Delim(']')
			}
		case "categories":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.Categories = append(out.Categories, v50)
					in.WantComma()
				}
				in.Delim(']')
			}
		case "subcategories":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.Subcategories = append(out.Subcategories, v51)
					in.WantComma()
				}
				in.Delim(']')
			}
		case "seasons":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.Seasons = append(out.Seasons, v52)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjson3e1fa5ecEncodeTryOnInternalPkgDomain35(out *jwriter.Writer, in ClothesClassificationRequest) {
	out.RawByte('{')
	first := true
	_ = first
	{
	...
	if len(in.Categories) != 0 {
		...
		{
			out.RawByte('[')
			for v57, v58 := range in.Categories {
				if v57 > 0 {
					out.RawByte(',')
				}
	...
	if len(in.Subcategories) != 0 {
		...
		{
			out.RawByte('[')
			for v59, v60 := range in.Subcategories {
				if v59 > 0 {
					out.RawByte(',')
				}
...
func easyjson3e1fa5ecDecodeTryOnInternalPkgDomain36(in *jlexer.Lexer, out *ClothesClassificationModelResponse) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
		...
		case "subcategories":
			if in.IsNull() {
				...
				for !in.IsDelim('}') {
					...
					in.WantColon()
					var v65 float32
					v65 = float32(in.Float32())
					(out.Subcategories)[key] = v65
					in.WantComma()
				}
				in.Delim('}')
			}
...
func easyjson3e1fa5ecEncodeTryOnInternalPkgDomain36(out *jwriter.Writer, in ClothesClassificationModelResponse) {
	out.RawByte('{')
	first := true
	_ = first
	if len(in.Tags) != 0 {
		...
		out.RawString(prefix[1:])
		{
			out.RawByte('{')
			v68First := true
			for v68Name, v68Value := range in.Tags {
				if v68First {
					v68First = false
				} else {
					out.RawByte(',')
	...
	if len(in.Categories) != 0 {
		...
		}
		{
			out.RawByte('{')
			v69First := true
			for v69Name, v69Value := range in.Categories {
				if v69First {
					v69First = false
				} else {
					out.RawByte(',')
	...
	if len(in.Subcategories) != 0 {
		...
		}
		{
			out.RawByte('{')
			v70First := true
			for v70Name, v70Value := range in.Subcategories {
				if v70First {
					v70First = false
				} else {
					out.RawByte(',')
	...
	if len(in.Seasons) != 0 {
		...
		}
		{
			out.RawByte('{')
			v71First := true
			for v71Name, v71Value := range in.Seasons {
				if v71First {
					v71First = false
				} else {
					out.RawByte(',')
	...
	if len(in.Styles) != 0 {
		...
		}
		{
			out.RawByte('{')
			v72First := true
			for v72Name, v72Value := range in.Styles {
				if v72First {
					v72First = false
				} else {
					out.RawByte(',')
...
func easyjson3e1fa5ecDecodeTryOnInternalPkgDomain37(in *jlexer.Lexer, out *Clothes) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
	...
	for !in.IsDelim('}') {
		...
		case "seasons":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v74 Season
					v74 = Season(in.String())
					out.Seasons = append(out.Seasons, v74)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjson3e1fa5ecEncodeTryOnInternalPkgDomain37(out *jwriter.Writer, in Clothes) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Name != "" {
