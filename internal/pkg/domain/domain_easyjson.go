	...
	for !in.IsDelim('}') {
		...
		case "clothes":
			if in.IsNull() {
				...
				in.Delim('{')
				if !in.IsDelim('}') {
					out.Clothes = make(map[utils.UUID]string)
				} else {
					out.Clothes = nil
				}
				for !in.IsDelim('}') {
...
func easyjson3e1fa5ecEncodeTryOnInternalPkgDomain5(out *jwriter.Writer, in TryOnRequest) {
	...
	if len(in.Clothes) != 0 {
		...
		}
		{
			out.RawByte('{')
			v5First := true
			for v5Name, v5Value := range in.Clothes {
				if v5First {
					v5First = false
				} else {
					out.RawByte(',')
...
func easyjson3e1fa5ecEncodeTryOnInternalPkgDomain6(out *jwriter.Writer, in TransformMap) {
	if in == nil && (out.Flags&jwriter.NilMapAsEmpty) == 0 {
		...
		for v7Name, v7Value := range in {
			...
			out.RawText((v7Name).MarshalText())
			out.RawByte(':')
		...
		case "subtypes":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.Subtypes = append(out.Subtypes, v14)
					in.WantComma()
				}
				in.Delim(']')
			}
		...
		case "styles":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.Styles = append(out.Styles, v24)
					in.WantComma()
				}
				in.Delim(']')
			}
		...
		case "subcategories":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.Subcategories = append(out.Subcategories, v26)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjson3e1fa5ecEncodeTryOnInternalPkgDomain16(out *jwriter.Writer, in ClothesClassificationRequest) {
	...
	if len(in.Subcategories) != 0 {
		...
		{
			out.RawByte('[')
			for v34, v35 := range in.Subcategories {
				if v34 > 0 {
					out.RawByte(',')
				}
